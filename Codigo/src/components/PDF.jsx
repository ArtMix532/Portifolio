...
import CV2 from "../assets/CVDaviGuimaraes.pdf";
    ...
    <div className="flex justify-center items-center h-screen flex-col gap-2">
      <div className="flex gap-5 px-5">
        <button
          type="button"
          onClick={() => setLang("pt")}
          className={`font-ubuntu btn btn-accent btn-soft btn-xl w-1/2 lg:w-52 flex items-center gap-2 ${
            lang === "pt" ? "btn-active" : ""
          }`}
        ...
        >
          ...
          <svg
            ...
            viewBox="0 0 640 448"
            className="size-[1.2em] rounded-[2px]"
          >
          ...
          <p className="text-slate-800">Portuguese</p>
        </button>

        <button
          type="button"
          onClick={() => setLang("en")}
          className={`font-ubuntu btn btn-info btn-soft btn-xl w-1/2 lg:w-52 flex items-center gap-2 ${
            lang === "en" ? "btn-active" : ""
          }`}
        ...
        >
          ...
          <p className="text-slate-800">English</p>
        </button>
      </div>

      <div className="w-full max-w-4xl lg:h-full h-3/4 shadow-lg rounded-lg overflow-hidden">
        <iframe

...
export const Time_Line = [
  {
    ...
    title: "School",
    text: "Colégio Santa Maria Minas.",
  },
  {
    icon: (
      <svg
    ...
    text: "I entered the Pontifical Catholic University of Minas Gerais in February 2024.",
  },
  {
    icon: (
      <svg
    ...
    text: "I started as an IT support intern in June 2024 and stayed until August 2025.",
  },
  {
    icon: (
      <svg
    ...
    title: "STR-Sistemas e VT-Real",
    text: "I started as a QA intern in August 2025 and I'm currently still in that role.",
  },
];
